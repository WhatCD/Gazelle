...
<!-- Actual Uploading Rules -->	
	...
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			...
			<li id="r2.2.8"><a href="#h2.2"><strong>&uarr;_</strong></a> <a href="#r2.2.8">2.2.8.</a> <strong>Bonus disc-only uploads can co-exist with the complete set in accordance with the trumping rules.</strong>  A bonus disc-only release can be trumped by an upload containing the "full" original album + bonus discs, in the same format, in accordance with the <a href="http://what.cd/rules.php?p=upload#r2.2.15">usual trump rules</a>.
			</li>
			...
			<li id="r2.2.15"><a href="#r2.2.15k"><strong>&uarr;_</strong></a> <a href="#r2.2.15">2.2.15.</a> <strong>Lossless Specific Dupe Rules</strong>
				...
				<ul>
					...
					<li id="r2.2.15.9"><a href="#r2.2.15"><strong>&uarr;_</strong></a> <a href="#r2.2.15.9">2.2.15.9.</a> <strong>No log editing is permitted.</strong> You may change the path of the files to hide your username or personal info in the home directory (e.g. C:\Documents and Settings\MyRealName\My Documents\) after ripping if need be. No other log editing is permitted. Forging log data is a serious misrepresentation of quality, and will result in a warning and permanent loss of upload privileges if found. <strong>Do not consolidate logs under any circumstances.</strong> If you must re-rip a disc and happen to have the new log appended to the original, leave them as-is. Do not remove any part of either log, and never copy/paste parts of a new log over an old log. If you find that an appended log has not been scored properly, please PM a moderator to get the score manually adjusted.
					</li>
	...
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			...
			<li id="r2.3.14"><a href="#h2.3"><strong>&uarr;_</strong></a> <a href="#r2.3.14">2.3.14.</a> <strong>The torrent artist for classical works should use the full composer name.</strong> Use the composer for "Artist" unless the album is a recital or contains works by several composers. Do not add the conductor or performer(s) to the composer's name as artist - you may add him/her/them at the end of the album title, though, in order to make it easier to distinguish between different recordings of the "same" work.
			</li>
			<li id="r2.3.15"><a href="#h2.3"><strong>&uarr;_</strong></a> <a href="#r2.3.15">2.3.15.</a> <strong>Newly re-tagged torrents trumping badly tagged torrents must reflect a substantial improvement over the previous tags.</strong> Small changes that include replacing ASCII characters with proper foreign language characters with diacritical marks, fixing slight misspellings, or missing an alternate spelling of an artist (e.g. excluding "The" before a band name) are insufficient grounds for replacing other torrents. You may trump a release if the tags do not follow the data from a reputable music cataloging service such as <a href="http://musicbrainz.org/">Musicbrainz</a> or <a href="http://www.discogs.com/">Discogs</a>. In case of conflict between reputable listings, either tagged version is equally preferred to the site and cannot trump the other. For example, an album is tagged differently in Musicbrainz and in Discogs. Either style of tagging is permitted; neither is "better" than the other. In that case, any newly tagged torrents replacing an already properly tagged torrent, which follows good tagging convention, will result in a dupe. <u>Exceptions</u>: Classical music has no easy tagging standard due to the incompatibilities with ID3 tag formats and classical meta data. Those may follow any standard as long as the tags are reasonable (i.e. not cut off, not misspelled beyond a few simple errors, not overly ambiguous, or uninformative). If you are not sure, you may follow guidelines at sites such as <a href="http://wiki.musicbrainz.org/ClassicalStyleGuide">MusicBrainz</a>, <a href="http://www.hydrogenaudio.org/forums/index.php?showtopic=70059">HydrogenAudio</a>, <a href="http://www.macworld.com/article/43791/2005/03/tagclass.html">this article</a>, or <a href="http://www.tunequest.org/on-classical-music-tagging-for-itunes-and-ipod/20060530/">this article</a>. <em>Note: <a href="http://wiki.musicbrainz.org/ClassicalStyleGuide">The MusicBrainz guide for classical tagging</a> may result in overly long tags, file names, and folder names. Some OSes (notably Windows), cannot read long folder and file names. It is advised to use it with ID3v2 and other tags that support long track names. However, use caution when naming the folders and files themselves.</em>
	...
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			...
			<li id="r7.4"><a href="#h7"><strong>&uarr;_</strong></a> <a href="#r7.4">7.4.</a> <strong>eLearning Videos must be either in a video file format (.avi, .mov, etc.) or a disk image (.iso, .bin/.cue, etc.).</strong> <u>Exceptions</u>: Only scene uploads may be archived into compressed archives (zip, rar, etc.).
			</li>
